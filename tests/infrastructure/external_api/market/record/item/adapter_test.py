...
def __test_sp_values(adapted_item_data, item_data):
    assert adapted_item_data.get("sp_back_price") == __get_sp_back(item_data)
...
def __test_ex_values(adapted_item_data, item_data):
    ...
    assert adapted_item_data.get("ex_back_size") == __calc_back_size(item_data)
...
def __calc_ex_average_back_price(item_data):
    ...
    ) / __calc_back_size(item_data)


def __calc_back_size(item_data):
