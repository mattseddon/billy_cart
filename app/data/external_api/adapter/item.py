...
class ItemAdapter:
    ...
    def __set_sp_back_price(self):
        ...
        self.__sp_back_price = price if self.__is_valid(price) else nan
        return None
    ...
    def __calc_ex_average_back_price(self):
        ...
        ex_average_back_price = (
            total_back_price / self.__ex_back_size if self.__ex_back_size else nan
        )
    ...
    def __calc_ex_average_lay_price(self):
        ...
        ex_average_lay_price = (
            total_lay_price / self.__ex_lay_size if self.__ex_lay_size else nan
        )
        return ex_average_lay_price

    def __set_ex_back_size(self):
        self.__ex_back_size = sum(
